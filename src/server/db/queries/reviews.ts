...
const reviseReview = (title: string, commentary: string, image_url: string, id: number) => Query<DbCannedResp>('UPDATE reviews SET title = ?, commentary = ?, image_url = ? WHERE id = ?', [title, commentary, image_url, id]);
